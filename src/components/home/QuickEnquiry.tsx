...
export const QuickEnquiry = () => {
  ...
  return <section className="py-16 bg-gradient-to-b from-white via-slate-50 to-gray-100">
      <div className="container mx-auto px-4 max-w-3xl">
        ...
        once: true
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5 p-8 rounded-xl shadow-lg bg-gradient-to-br from-white to-slate-100 border border-gray-200">
            ...
            <div>
              <ReCAPTCHA sitekey="6LdmlJMrAAAAAISp1BfEDn90djyWcnCvOwLSCnbQ" onChange={token => {
            ...
            scale: 0.98
              ...
              <Button type="submit" disabled={isSubmitting} className="w-full transition-colors text-slate-50 bg-gradient-to-r from-[#D4AF37] to-[#f6b100] hover:from-[#f6b100] hover:to-[#D4AF37] shadow-md hover:shadow-gold-glow bg-brand-navy">
                {isSubmitting ? <>
