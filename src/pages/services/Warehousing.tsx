            ...
            <div className="flex flex-col md:flex-row items-center gap-8">
              <div className="md:w-1/2">
                ...
                >
                  ...
                  Our solutions are tailored to meet the diverse needs of businesses, ensuring efficiency, reliability, and scalability.
                </motion.p>
                <motion.div
                  initial={{ opacity: 0, y: 20 }}
                  animate={{ opacity: 1, y: 0 }}
                ...
                >
                  <AspectRatio ratio={16 / 9}>
                    <img
                      ...
                      src="/lovable-uploads/6443996b-8be8-4116-b844-0847fca71e52.png"
                    />
                  </AspectRatio>
                </motion.div>
              </div>
